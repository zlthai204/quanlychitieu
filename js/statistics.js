...
function statisticsGetDishCost(
    ...
    /*
     * Ưu tiên hàm dùng chung nếu project có.
     */
    ...
    /*
     * Tìm món từ AppState.dishes.
     *
     * Giá vốn được lưu trong:
     * dish.cod_parts = [
     *   { name, amount, note }
     * ]
     *
     * Tổng vốn = tổng amount của các thành phần.
     */
    ...
    /*
     * Fallback cho dữ liệu giao dịch
     * cũ nếu đã có cột cost/dish_cost/food_cost.
     */
...
function calculatePeriodCODCost(
    ...
    transactions.forEach(
        transaction => {
            ...
            /*
             * Giá vốn chỉ thuộc giao dịch THU
             * có món ăn.
             */
